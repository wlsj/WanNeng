...
public class WangLuoQingQiu {
    ...
    private static WangLuoQingQiu sNewInstance;
    ...
    private static class SingletonHolder {
        private static WangLuoQingQiu INSTANCE = new WangLuoQingQiu(
                mContext);
    }

    public static WangLuoQingQiu getInstance(Context context) {
        if (context != null) {
            mContext = context;
        }
    ...
    public static WangLuoQingQiu getInstance(Context context, String url) {
        if (context != null) {
            mContext = context;
        }

        return new WangLuoQingQiu(context, url);
    }

    public static WangLuoQingQiu getInstance(Context context, String url, Map<String, String> headers) {
        if (context != null) {
            mContext = context;
        }
        return new WangLuoQingQiu(context, url, headers);
    }

   private WangLuoQingQiu() {

   }

    private WangLuoQingQiu(Context context) {

        this(context, baseUrl, null);
    }

    private WangLuoQingQiu(Context context, String url) {

        this(context, url, null);
    }

    private WangLuoQingQiu(Context context, String url, Map<String, String> headers) {
   ...
   /**
     ...
     * @return ApiManager
     */
    public WangLuoQingQiu createBaseApi() {
