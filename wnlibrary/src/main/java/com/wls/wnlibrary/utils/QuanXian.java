 ...
 * </pre>
 */
public final class QuanXian {

    private static final List<String> PERMISSIONS = getPermissions();

    private static QuanXian sInstance;
     ...
     *
     * @param permissions The permissions.
     * @return the single {@link QuanXian} instance
     */
    public static QuanXian permission(@PermissionConstants.Permission final String... permissions) {
        return new QuanXian(permissions);
    }

    private QuanXian(final String... permissions) {
     ...
     * @return the single {@link QuanXian} instance
     */
    public QuanXian rationale(final OnRationaleListener listener) {
     ...
     * @return the single {@link QuanXian} instance
     */
    public QuanXian callback(final SimpleCallback callback) {
     ...
     * @return the single {@link QuanXian} instance
     */
    public QuanXian callback(final FullCallback callback) {
     ...
     * @return the single {@link QuanXian} instance
     */
    public QuanXian theme(final ThemeCallback callback) {
    ...
    public static class PermissionActivity extends Activity {
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            if (sInstance == null) {
                ...
                Log.e("QuanXian", "request permissions failed");
                finish();
                return;
            }
